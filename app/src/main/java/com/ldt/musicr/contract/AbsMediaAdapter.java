 ...
 * <br> Long press
 */
public abstract class AbsMediaAdapter<VH extends AbsBindAbleHolder, I extends Media> extends
   AbsDataAdapter<VH, I> {
 ...
 /*   public final void notifyOnMediaStateChanged() {
  ...
  public class AbsMediaHolder<I extends Media> extends AbsBindAbleHolder<I> implements
