...
public class PlaylistSongLoader {
  ...
  @NonNull
  public static List<Integer> getPlaylistSongIds(
  ...
  @NonNull
  public static ArrayList<PlaylistSong> getPlaylistSongList(
     @NonNull final Context context,
     final int playlistId
  ) {
  ...
  @NonNull
  private static PlaylistSong getPlaylistSongFromCursorImpl(
