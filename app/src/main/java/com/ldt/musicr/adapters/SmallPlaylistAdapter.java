...
import com.ldt.musicr.fragments.PlaylistPageFragment;
import com.ldt.musicr.fragments.ShowMusicSongs;
    ...
    public void onBindViewHolder(final ItemHolder itemHolder,int i) {
        ...
        new AsyncTask<Void,Void,Bitmap>() {
            ...
            protected Bitmap doInBackground(Void... v) {
                ...
                return AutoGeneratedPlaylistBitmap.getBitmap(mContext,l,true,true);
            }
        }.execute();
    ...
    public class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener,View.OnTouchListener{
        ...
        public void onClick(View v) {
            ...
            v.startAnimation(myAnim);
                    ((SupportFragmentPlusActivity) mContext).pushFragment(PlaylistPageFragment.Initialize(mContext,arraylist.get(position),position), true);
