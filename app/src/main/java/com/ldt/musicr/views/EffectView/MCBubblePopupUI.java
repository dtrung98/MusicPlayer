...
import com.ldt.musicr.MediaData.FormatDefinition.C_PointF;
import com.ldt.musicr.MediaData.FormatDefinition.C_RectF;
...
public class MCBubblePopupUI extends View {
    ...
    public MCBubblePopupUI(Context context) {
        super(context);
        init();
    }

    public MCBubblePopupUI(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MCBubblePopupUI(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
