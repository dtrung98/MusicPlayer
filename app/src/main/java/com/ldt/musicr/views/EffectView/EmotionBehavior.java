...
public class EmotionBehavior implements AnimateDrawable {
   ...
   // bút vẽ màu
    ...
    // ???
    ImageView iconView;
    // bức bitmap icon và bitmap focus
    ...
    private com.ldt.musicr.views.EffectView.MCBubblePopupUI.MCAttributes attr;
    ...
    EmotionBehavior(MCBubblePopupUI MCBubblePopupUI)
    {
