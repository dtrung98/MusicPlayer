...
public class RoundedBottomSheetDialogFragment extends BottomSheetDialogFragment implements View.OnClickListener,MusicStateListener {
...
public void setListener(BottomSheetListener listener) {
    ...
    public static RoundedBottomSheetDialogFragment newInstance() {
