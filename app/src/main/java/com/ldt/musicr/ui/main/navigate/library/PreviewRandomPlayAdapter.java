...
public class PreviewRandomPlayAdapter extends RecyclerView.Adapter<PreviewRandomPlayAdapter.ItemHolder> {
    ...
    public void shuffle() {
        ...
        handler.postDelayed(() -> {
            MusicPlayer.playAll(mContext, getRealSongIds(), 0, -1,TimberUtils.IdType.NA, false);
            randommize();
        },100);
    }
    ...
    class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            final Handler handler = new Handler();
            handler.postDelayed(() -> {
                MusicPlayer.playAll(mContext, getRealSongIds(), getAdapterPosition(), -1,TimberUtils.IdType.NA, false);
                randommize();
            },100);
        }
    }
