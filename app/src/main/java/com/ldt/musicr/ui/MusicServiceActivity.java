...
public abstract class MusicServiceActivity extends AppCompatActivity implements
   MusicServiceEventListener {
  private final ArrayList<MusicServiceEventListener> mMusicServiceEventListeners =
     new ArrayList<>();
  ...
  public void addMusicServiceEventListener(
     final MusicServiceEventListener listener,
     boolean firstIndex
  ) {
    if (listener == this) {
  ...
  private Context updateBaseContextLocale(Context context) {
    String language = LocaleHelper.getLanguage(context); // Helper method to get saved language
