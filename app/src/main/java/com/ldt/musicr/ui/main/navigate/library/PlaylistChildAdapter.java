...
import com.ldt.musicr.ui.main.navigate.AdapterOnClickItemListener;
...
public class PlaylistChildAdapter extends RecyclerView.Adapter<PlaylistChildAdapter.ItemHolder> {
    ...
    public AdapterOnClickItemListener<Playlist> mListener;
    ...
    public void setOnItemClickListener(AdapterOnClickItemListener<Playlist> listener) {
        mListener = listener;
    }
    ...
    public class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener,View.OnTouchListener{
        ...
        public void onClick(View v) {
            ...
            if(mListener!=null) mListener.onAdapterItemClick(v,mPlaylistData.get(getAdapterPosition()),getAdapterPosition());
