...
public class SinglePlaylistPresentationFragment extends PresentationFragment implements MusicServiceEventListener, SortOrderBottomSheet.SortOrderChangedListener, EventListener<SinglePlaylistViewModel.State> {
 ...
 /*   public void setTheme() {
    ...
    public static SinglePlaylistPresentationFragment newInstance(Playlist playlist, @Nullable Bitmap previewBitmap) {
        SinglePlaylistPresentationFragment fragment = new SinglePlaylistPresentationFragment();
