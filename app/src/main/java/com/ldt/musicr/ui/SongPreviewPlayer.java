...
public class SongPreviewPlayer implements MusicServiceEventListener {
    ...
    private ArrayList<PreviewPlayer> mPreviewPlayers = new ArrayList<>();
    private static class PreviewPlayer {
        private final int mStart;
        private final int mFinish;
        private final MediaPlayer mPlayer;

        public PreviewPlayer(int start, int finish, MediaPlayer player) {
            this.mStart = start;
            this.mFinish = finish;
            this.mPlayer = player;
        }
...
//            SmoothedPenGain[i_pen] = getHeight(i_pen, numberPenGain_Guess, originalPenGain, scaleFactor, minGain, range);
    ...
    private static class SoundFileLoader extends AsyncTask< File, Void, Void > implements CheapSoundFile.ProgressListener {
        SongPreviewPlayer mAudioPreviewPlayer;
        boolean mKeeping = true;
        boolean isFinished = false;
        public SoundFileLoader(SongPreviewPlayer bs) {
