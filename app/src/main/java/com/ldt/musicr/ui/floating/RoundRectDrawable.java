...
public class RoundRectDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
       ...
       // canvas.drawRoundRect(mBoundsF.left, mBoundsF.top, mBoundsF.right, mBoundsF.bottom + mRadius, 0, 0, paint);
    ...
    private void updateBounds(Rect bounds) {
       ...
       // mBoundsI.set(bounds);
        ...
        mBoundsF.set(bounds.left, bounds.top, bounds.right, bounds.bottom + mRadius);
        mBoundsI.set(bounds.left, bounds.top, bounds.right, (int) (bounds.bottom + mRadius));
