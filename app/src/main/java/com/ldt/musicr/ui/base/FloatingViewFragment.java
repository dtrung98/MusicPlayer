 ...
 * <br/> Back pressed event is handled automatically by default, but you have an option to
 * disable it
 */
  ...
  public final ViewGroup requireDialogContainerView() {
    ...
    if (containerView == null) {
      throw new IllegalStateException(
         "PersistentDialogFragment " + this + " does not have a container view.");
    }
    ...
    requireActivity().getOnBackPressedDispatcher()
       .addCallback(this, new OnBackPressedCallback(true) {
         ...
         public void handleOnBackPressed() {
           if (mCancelable) {
             if (getParentFragmentManager().getPrimaryNavigationFragment() ==
                FloatingViewFragment.this) {
