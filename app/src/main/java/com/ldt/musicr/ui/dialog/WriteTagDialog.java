...
public class WriteTagDialog extends LoadingScreenDialog {
  ...
  private void scan(String[] fileToBeScanned) {
    ...
    MediaScannerConnection.scanFile(context,
       ...
       context instanceof Activity ?
          new UpdateToastMediaScannerCompletionListener((Activity) context,
          fileToBeScanned) : null);
  }
  ...
  public static class LoadingInfo {
    ...
    public LoadingInfo(
       ...
       @Nullable ArtworkInfo artworkInfo
    ) {
      ...
      try {
        ...
        if (info.artworkInfo != null && info.artworkInfo.artwork != null) {
          try {
            ...
            info.artworkInfo.artwork.compress(Bitmap.CompressFormat.PNG,
               0,
               new FileOutputStream(albumArtFile));
