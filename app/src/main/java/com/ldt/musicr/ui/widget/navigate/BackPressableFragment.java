...
public class BackPressableFragment extends Fragment implements BackPressable {
  ...
  private void initBackStack(Bundle savedInstanceState) {
    ...
    //          mNavigationController = (FragmentNavigationController) fm.getFragment
    //          (savedInstanceState,"navigation-controller");
    //          if(mNavigationController==null) Log.d(TAG, "initBackStack: found Navigation
    //          Controller");
