...
public class PresentStyle {
  ...
  public PresentStyle(
     int openEnterAnimatorId,
     int openExitAnimatorId,
     int closeEnterAnimatorId,
     int closeExitAnimatorId
  ) {
  ...
  private static PresentStyle AccordionLeft() {
    return new PresentStyle(R.animator.accordion_right_in,
       R.animator.accordion_left_out,
       R.animator.accordion_left_in,
       R.animator.accordion_right_out);
  }

  private static PresentStyle AccordionRight() {
    return new PresentStyle(R.animator.accordion_left_in,
       R.animator.accordion_right_out,
  ...
  private static PresentStyle AccordionUp() {
    return new PresentStyle(R.animator.accordion_vertical_right_in,
       R.animator.accordion_vertical_left_out,
       R.animator.accordion_vertical_left_in,
       R.animator.accordion_vertical_right_out);
  }

  private static PresentStyle AccordionDown() {
    return new PresentStyle(R.animator.accordion_vertical_left_in,
       R.animator.accordion_vertical_right_out,
       R.animator.accordion_vertical_right_in,
       R.animator.accordion_vertical_left_out);
  }

  private static PresentStyle Fade() {
    return new PresentStyle(R.animator.fade_in,
       R.animator.fade_out,
       R.animator.fade_in,
       R.animator.fade_out);
  }
  ...
  private static PresentStyle CubeLeft() {
    return new PresentStyle(R.animator.cube_right_in,
  ...
  private static PresentStyle CubeRight() {
    return new PresentStyle(R.animator.cube_left_in,
       R.animator.cube_right_out,
  ...
  private static PresentStyle CubeUp() {
    return new PresentStyle(R.animator.cube_vertical_right_in,
       R.animator.cube_vertical_left_out,
       R.animator.cube_vertical_left_in,
       R.animator.cube_vertical_right_out);
  }

  private static PresentStyle CubeDown() {
    return new PresentStyle(R.animator.cube_vertical_left_in,
       R.animator.cube_vertical_right_out,
       R.animator.cube_vertical_right_in,
       R.animator.cube_vertical_left_out);
  }

  private static PresentStyle CardFlipLeft() {
    return new PresentStyle(R.animator.card_flip_horizontal_right_in,
  ...
  private static PresentStyle CardFlipRight() {
    return new PresentStyle(R.animator.card_flip_horizontal_left_in,
       R.animator.card_flip_horizontal_right_out,
  ...
  private static PresentStyle CardFlipDown() {
    return new PresentStyle(R.animator.card_flip_vertical_right_in,
  ...
  private static PresentStyle CardFlipUp() {
    return new PresentStyle(R.animator.card_flip_vertical_left_in,
       R.animator.card_flip_vertical_right_out,
  ...
  private static PresentStyle Glide() {
    return new PresentStyle(R.animator.glide_fragment_horizontal_in,
  ...
  private static PresentStyle RotateDownLeft() {
    return new PresentStyle(R.animator.rotatedown_right_in,
       R.animator.rotatedown_left_out,
       R.animator.rotatedown_left_in,
       R.animator.rotatedown_right_out);
  }

  private static PresentStyle RotateDownRight() {
    return new PresentStyle(R.animator.rotatedown_left_in,
       R.animator.rotatedown_right_out,
  ...
  private static PresentStyle RotateUpLeft() {
    return new PresentStyle(R.animator.rotateup_right_in,
       R.animator.rotateup_left_out,
       R.animator.rotateup_left_in,
       R.animator.rotateup_right_out);
  }

  private static PresentStyle RotateUpRight() {
    return new PresentStyle(R.animator.rotateup_left_in,
       R.animator.rotateup_right_out,
       R.animator.rotateup_right_in,
       R.animator.rotateup_left_out);
  }

  private static PresentStyle RotateLeftUp() {
    return new PresentStyle(R.animator.rotateleft_right_in,
       R.animator.rotateleft_left_out,
       R.animator.rotateleft_left_in,
       R.animator.rotateleft_right_out);
  }

  private static PresentStyle RotateLeftDown() {
    return new PresentStyle(R.animator.rotateleft_left_in,
       R.animator.rotateleft_right_out,
       R.animator.rotateleft_right_in,
       R.animator.rotateleft_left_out);
  }

  private static PresentStyle RotateRightUp() {
    return new PresentStyle(R.animator.rotateright_right_in,
       R.animator.rotateright_left_out,
       R.animator.rotateright_left_in,
       R.animator.rotateright_right_out);
  }

  private static PresentStyle RotateRightDown() {
    return new PresentStyle(R.animator.rotateright_left_in,
       R.animator.rotateright_right_out,
       R.animator.rotateright_right_in,
       R.animator.rotateright_left_out);
  }

  private static PresentStyle ScaleX() {
    return new PresentStyle(R.animator.scalex_enter,
  ...
  private static PresentStyle ScaleY() {
    return new PresentStyle(R.animator.scaley_enter,
  ...
  private static PresentStyle ScaleXY() {
    return new PresentStyle(R.animator.scalexy_enter,
       R.animator.scalexy_exit,
       R.animator.scalexy_enter,
       R.animator.scalexy_exit);
  }

  private static PresentStyle SlideLeft() {
    return new PresentStyle(R.animator.slide_fragment_horizontal_right_in,
  ...
  private static PresentStyle SlideRight() {
    return new PresentStyle(R.animator.slide_fragment_horizontal_left_in,
       R.animator.slide_fragment_horizontal_right_out,
  ...
  private static PresentStyle SlideUp() {
    return new PresentStyle(R.animator.slide_fragment_vertical_right_in,
  ...
  private static PresentStyle SlideDown() {
    return new PresentStyle(R.animator.slide_fragment_vertical_left_in,
       R.animator.slide_fragment_vertical_right_out,
  ...
  private static PresentStyle StackLeft() {
    return new PresentStyle(R.animator.stack_right_in,
  ...
  private static PresentStyle TableLeft() {
    return new PresentStyle(R.animator.table_horizontal_right_in,
       R.animator.table_horizontal_left_out,
       R.animator.table_horizontal_left_in,
       R.animator.table_horizontal_right_out);
  }

  private static PresentStyle TableRight() {
    return new PresentStyle(R.animator.table_horizontal_left_in,
       R.animator.table_horizontal_right_out,
  ...
  private static PresentStyle TableUp() {
    return new PresentStyle(R.animator.table_vertical_right_in,
       R.animator.table_vertical_left_out,
       R.animator.table_vertical_left_in,
       R.animator.table_vertical_right_out);
  }

  private static PresentStyle TableDown() {
    return new PresentStyle(R.animator.table_vertical_left_in,
       R.animator.table_vertical_right_out,
  ...
  private static PresentStyle ZoomFromLeftTopCorner() {
    return new PresentStyle(R.animator.zoom_from_left_corner_right_in,
  ...
  private static PresentStyle ZoomFromLeftBottomCorner() {
    return new PresentStyle(R.animator.zoom_from_right_corner_left_in,
  ...
  private static PresentStyle ZoomFromRightTopCorner() {
    return new PresentStyle(R.animator.zoom_from_right_corner_right_in,
       R.animator.zoom_from_right_corner_left_out,
  ...
  private static PresentStyle ZoomFromRightBottomCorner() {
    return new PresentStyle(R.animator.zoom_from_left_corner_left_in,
       R.animator.zoom_from_left_corner_right_out,
