...
public class NowPlayingAdapter extends RecyclerView.Adapter<NowPlayingAdapter.ItemHolder> implements
   Callback {
  ...
  public ItemHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    View v = LayoutInflater.from(viewGroup.getContext())
       .inflate(R.layout.item_art_now_playing, viewGroup, false);
 ...
 /*           Picasso.get().load(Util.getAlbumArtUri(song.albumId))
      ...
      ArtworkUtils.getBitmapRequestBuilder(itemView.getContext(), song)
         ...
         .error(
            ArtistGlideRequest.Builder.from(GlideApp.with(mContext), artist)
               ...
               .build()
               .error(ArtistGlideRequest.Builder.from(GlideApp.with(mContext), artist)
     ...
     /*       ArtistGlideRequest.Builder.from(GlideApp.with(getContext()), mArtist)
            ...
            Glide.with(mContext).load(Util.getAlbumArtUri(song.albumId)).apply(options).error(R
            .drawable.speaker2).placeholder(R.drawable.speaker2).into(mImage);*/
