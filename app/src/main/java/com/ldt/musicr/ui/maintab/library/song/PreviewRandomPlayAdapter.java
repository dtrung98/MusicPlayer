...
public class PreviewRandomPlayAdapter extends
   RecyclerView.Adapter<PreviewRandomPlayAdapter.ItemHolder> {
  ...
  public ItemHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    View v = LayoutInflater.from(viewGroup.getContext())
       .inflate(R.layout.item_preview_random_play, viewGroup, false);
  ...
  class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public void onClick(View v) {
      ...
      handler.postDelayed(() -> {
        ...
        //MusicPlayer.playAll(mContext, getRealSongIds(), getAdapterPosition(), -1, Util.IdType
        // .NA, false);
        randomize();
      }, 100);
    }
