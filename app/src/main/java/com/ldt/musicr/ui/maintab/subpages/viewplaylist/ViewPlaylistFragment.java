...
public class ViewPlaylistFragment extends MusicServiceNavigationFragment implements
   SortOrderBottomSheet.SortOrderChangedListener, EventListener<ViewPlaylistViewModel.State> {
 ...
 /*   public void setTheme() {
  ...
  public static ViewPlaylistFragment newInstance(
     Playlist playlist,
