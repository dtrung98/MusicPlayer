...
public class ViewPlaylistHeaderAdapter extends
   RecyclerView.Adapter<ViewPlaylistHeaderAdapter.HeaderViewHolder> {
  ...
  public HeaderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    return new HeaderViewHolder(LayoutInflater.from(parent.getContext())
       .inflate(R.layout.item_single_playlist_header, parent, false));
  }
  ...
  final class HeaderViewHolder extends RecyclerView.ViewHolder {
    ...
    void clickMenu(View v) {
      if (getEventListener() != null) {
        getEventListener().handleEvent(new ReliableEvent<>(Reliable.success(null),
           ACTION_CLICK_MENU));
      }
    }
