...
public class NavigationControllerFragment extends NavigationFragment {
  ...
  private NavigationControllerFragment(
  ...
  public static NavigationControllerFragment navigationController(
     @NonNull FragmentManager fragmentManager,
     @IdRes int containerViewId
  ) {
  ...
  public boolean dismissFragment(boolean withAnimation) {
    if (mIsAbleToPopRoot) {
      return dismissFragmentIncludingRoot(withAnimation);
    } else {
      return dismissFragmentWithoutRoot(withAnimation);
    }
  }
