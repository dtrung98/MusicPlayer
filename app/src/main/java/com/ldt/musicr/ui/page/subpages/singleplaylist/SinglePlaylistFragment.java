...
public class SinglePlaylistFragment extends MusicServiceNavigationFragment implements SortOrderBottomSheet.SortOrderChangedListener, EventListener<SinglePlaylistViewModel.State> {
 ...
 /*   public void setTheme() {
    ...
    public static SinglePlaylistFragment newInstance(Context context, Playlist playlist, @Nullable Bitmap previewBitmap) {
    ...
    public void onSetStatusBarMargin(int value) {
      /*  ((ViewGroup.MarginLayoutParams) toolbar.getLayoutParams()).topMargin = value;
        ...
        mBackConstraint.setPadding(mBackConstraint.getPaddingLeft(), padding_top_back_constraint, mBackConstraint.getPaddingRight(), 0);
*/
    }
