...
public class PlaylistChildTab extends MusicServiceFragment implements
   FeaturePlaylistAdapter.PlaylistClickListener {
    ...
    ViewCompat.setOnApplyWindowInsetsListener(mRecyclerView, new OnApplyWindowInsetsListener() {
      ...
      public WindowInsetsCompat onApplyWindowInsets(View v, WindowInsetsCompat insets) {
        ...
        v.setPadding(_8dp + insets.getSystemWindowInsetLeft(),
           ...
           _8dp + (int) (insets.getSystemWindowInsetBottom() +
