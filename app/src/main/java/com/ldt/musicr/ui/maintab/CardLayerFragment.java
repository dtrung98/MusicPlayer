  ...
  public final View onCreateView(
    ...
    if (mMaxPosition == 0) {
      if (isFullscreenLayer()) {
        mMaxPosition = mCardLayerController.screenSize[1];
      } else {
        mMaxPosition = (int) (mCardLayerController.screenSize[1] -
           mCardLayerController.statusBarHeight - 2 * mCardLayerController.oneDp -
           mCardLayerController.maxMarginTop);
      }
    }
