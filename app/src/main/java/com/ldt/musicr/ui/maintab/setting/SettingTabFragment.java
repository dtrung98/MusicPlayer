...
public class SettingTabFragment extends MusicServiceNavigationFragment implements
  ...
  void onChangedUseArtistImgAsBg(boolean value) {
    ...
    EventBus.getDefault()
       .post(new MessageEvent(EventKey.SettingKey.ChangedSetArtistArtworkAsBackground.INSTANCE,
          null,
          null,
          null));
  }
  ...
  void refreshData() {
    refreshInAppVolume();
    refreshBalanceValue();
    mUseArtistImgAsBg.setChecked(App.getInstance()
       .getPreferencesUtility()
       .isUsingArtistImageAsBackground());
  ...
  public void onPaletteChanged() {
    ...
    DrawableCompat.setTintList(DrawableCompat.wrap(mUseArtistImgAsBg.getThumbDrawable()),
       new ColorStateList(states, thumbColors));
    DrawableCompat.setTintList(DrawableCompat.wrap(mUseArtistImgAsBg.getTrackDrawable()),
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
         ...
         /*   ColorStateList colorStateList = new ColorStateList(
                    new int[][] {new int[] {android.R.attr.state_pressed},new int[] {android.R
                    .attr.state_focused}},
    ...
    if (mIsEnglish) {
      ...
      mSwitchToVi.setTextColor(color);
    }
