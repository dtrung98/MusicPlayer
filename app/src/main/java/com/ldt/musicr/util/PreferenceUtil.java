...
public final class PreferenceUtil {
  ...
  public static final String NEXT_SLEEP_TIMER_ELAPSED_REALTIME =
  ...
  // The last added cutoff time is compared against the Android media store timestamps, which is
  // seconds based.
  public long getLastAddedCutoffTimeSecs() {
    return getCutoffTimeMillis(LAST_ADDED_CUTOFF) / 1000;
  }

  // The recently played cutoff time is compared against the internal (private) database
  // timestamps, which is milliseconds based.
  ...
  /*
         ...
         return new File(mPreferences.getString(START_DIRECTORY, FoldersFragment
         .getDefaultStartDirectory().getPath()));
     }
 */
