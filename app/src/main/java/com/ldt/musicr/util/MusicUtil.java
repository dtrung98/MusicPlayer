...
public class MusicUtil {
  ...
  public static Intent createShareSongFileIntent(@NonNull final Song song, Context context) {
    try {
      ...
      // TODO the data is most likely not like /storage/emulated/0/... but something like
      //  /storage/28C7-75B0/...
      e.printStackTrace();
    ...
    try {
      ...
      try {
        if (cursor != null && cursor.getCount() == 1) {
          ...
          final String message = context.getString(R.string.x_has_been_set_as_ringtone,
             cursor.getString(0));
  ...
  @NonNull
  public static String getArtistInfoString(
  ...
  @NonNull
  public static String getAlbumInfoString(
     @NonNull final Context context,
     @NonNull final Album album
  ) {
  ...
  @NonNull
  public static String getGenreInfoString(
     @NonNull final Context context,
  ...
  @NonNull
  public static String getPlaylistInfoString(
     @NonNull final Context context,
  ...
  public static String getSongCountString(@NonNull final Context context, int songCount) {
    final String songString =
       songCount == 1 ? context.getResources().getString(R.string.songs) : context.getResources()
  ...
  public static String getAlbumCountString(@NonNull final Context context, int albumCount) {
    final String albumString =
       albumCount == 1 ? context.getResources().getString(R.string.albums) : context.getResources()
  ...
  public static boolean isFavoritePlaylist(
     @NonNull final Context context,
  ...
  public static Playlist getFavoritesPlaylist(@NonNull final Context context) {
    ...
    /*private static Playlist getOrCreateFavoritesPlaylist(@NonNull final Context context) {
        return PlaylistLoader.getPlaylist(context, PlaylistsUtil.createPlaylist(context, context
  ...
  public static String getLyrics(Song song) {
    ...
    if (lyrics == null || lyrics.trim().isEmpty() ||
       !AbsSynchronizedLyrics.isSynchronized(lyrics)) {
  ...
  public static List<Song> getPlaylistSongList(
    ...
    if (list.name.equals(context.getString(R.string.playlist_last_added))) {
      ...
      List<Song> songlist = new ArrayList<>(PlaylistSongLoader.getPlaylistSongList(context,
         list.id));
      return songlist;
    }
  }
