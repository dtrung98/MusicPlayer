...
public final class FileUtil {
  ...
  @NonNull
  public static ArrayList<Song> matchFilesWithMediaStore(
  ...
  public static SortedCursor makeSongCursor(
    ...
    Cursor songCursor = SongLoader.makeSongCursor(context,
       selection,
       selection == null ? null : paths);

    return songCursor == null ? null : new SortedCursor(songCursor,
       paths,
