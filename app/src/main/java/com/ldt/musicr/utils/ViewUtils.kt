...
object ViewUtils {
  ...
  fun setSpanToHighlightPositions(
    stringBuilder: Spannable,
    start: Int,
    end: Int,
    typefaceValue: Int
  ) {
  ...
  fun getHighlightedText(
    orgText: CharSequence,
    spanPosArray: MutableList<Int>,
    foregroundColor: Int = ColorProvider.baseColor,
    typefaceValue: Int = NOT_SET
  ): CharSequence {
