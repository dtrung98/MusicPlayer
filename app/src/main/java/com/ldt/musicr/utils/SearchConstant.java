...
public class SearchConstant {
  ...
  public static final int SEARCH_FLAG_PREPROCESS_SPLIT_WORD_EXTEND =
     1 << 20; // flag used for pre-processing method only
  public static final int SEARCH_FLAG_PREPROCESS_SPLIT_WORD_ENHANCED =
     1 << 21; // flag used for pre-processing method only
