...
public class MusicPlayerRemote {
  ...
  public static void playOrPause() {
    if (musicService != null) {
      ...
      Log.d(TAG, "playOrPause: music service is null");
    }
  }
  ...
  private static boolean tryToHandleOpenPlayingQueue(
     final List<Song> queue,
     final int startPosition,
     final boolean startPlaying
  ) {
  ...
  public static boolean playNext(@NonNull ArrayList<Song> songs) {
    if (musicService != null) {
      ...
      final String toast = songs.size() == 1 ? musicService.getResources()
         .getString(R.string.added_title_to_playing_queue) : musicService.getResources()
  ...
  public static boolean moveSong(int from, int to) {
    if (musicService != null && from >= 0 && to >= 0 && from < getPlayingQueue().size() &&
    ...
    if (musicService != null) {
      ...
      if (songs == null) {
        ...
        if (uri.getAuthority() != null &&
           uri.getAuthority().equals("com.android.externalstorage.documents")) {
