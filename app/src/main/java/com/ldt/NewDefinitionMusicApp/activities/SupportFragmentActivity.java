...
import com.ldt.NewDefinitionMusicApp.fragments.BackWall;
import com.ldt.NewDefinitionMusicApp.fragments.FragmentHolder.BottomUpTransition;
import com.ldt.NewDefinitionMusicApp.fragments.FragmentHolder.FadeInFadeOutTransition;
import com.ldt.NewDefinitionMusicApp.fragments.FragmentHolder.RightToLeftTransition;
import com.ldt.NewDefinitionMusicApp.fragments.FragmentHolder.Prepare4Fragment;
import com.ldt.NewDefinitionMusicApp.fragments.FragmentPlus;
import com.ldt.NewDefinitionMusicApp.fragments.MusicControllerFragment;
import com.ldt.NewDefinitionMusicApp.fragments.PlaylistControllerFragment;
import com.ldt.NewDefinitionMusicApp.views.roundClippingFrameLayout;
...
public abstract class SupportFragmentActivity extends AppCompatActivity {
    ...
    private final int CYCLE_LOAD_WALLPAPER = 5000; // 5 giay test mot lan
    ...
    public int pixel_unit  = 0;
    public FrameLayout control_container;
    public View navigation_bar;
    public roundClippingFrameLayout switch_page_container;
    public View statusColor4Lolipop;

    protected void checkNSwitch()
    {
        if(orderThemeActivity!=nowThemeAcitivity) switchThemeActivity();
    }
    private void switchThemeActivity()
    {
    ...
    public final void OrderToChangeStatusTheme(MusicControllerFragment musicControllerFragment)
    {
    ...
    private void updateWhenChangeFragmentTop()
    {
    ...
    private void Initialize_Everything4WallpaperCycler()
    {
        ...
        valueAnimator.setDuration(0); // don't change this
            ...
            public void onAnimationEnd(Animator animation) {
                new AsyncTask<Void, Void, Void>() {
                    ...
                    protected void onPostExecute(Void aVoid) {
                        valueAnimator.setStartDelay(CYCLE_LOAD_WALLPAPER);
                        valueAnimator.start();
                    }
    ...
    {
        Bitmap blur  = ImageEditor.getBlurredWithGoodPerformance(this,old,1,12,1.4f);
    ...
    public enum MenuType {
        CONTAINER, BACK_WALL,CONTROL
    }

    public enum TransitionType {
        LEFT2RIGHT,BOTTOM_UP,FADE_IN_OUT,SPECIAL_TYPE
    }
...
protected final void callSuperMergeUI()
{
    ...
    control_container =findViewById(R.id.control_container);
    switch_page_container =findViewById(R.id.fragment_switch_container);
...
protected void turnOnTranslucent(boolean on)
{
    ...
    public void pushFragment(FragmentPlus fragment, boolean shouldAdd) {
        ...
        if(numberStack>=1)
        {
            ...
            switch_page_container.addView(fragment.getFrameLayout(),params1);
    ...
    public FrameLayout getContainer(MenuType menuType)
    {
        switch (menuType)
        {
            ...
            case CONTROL:    return (FrameLayout)findViewById(R.id.control_container);
            case CONTAINER : default:
                                        return (FrameLayout)findViewById(R.id.fragment_switch_container);
        }
    }
    ...
    private void TransitionAdding(SupportFragmentActivity activity, FragmentPlus NewFragment, FragmentPlus BackFragment)
    {
        inTransition = true;
        ...
        switch (tT)
        {
            ...
            case LEFT2RIGHT: RightToLeftTransition.AddFragmentAndTransform(activity,NewFragment,BackFragment);break;
        }
    }
    ...
    private void TransitionRemoving(FragmentPlus NewFragment,FragmentPlus BackFragment)
    {
        ...
        switch (tT)
        {
            ...
            case LEFT2RIGHT: RightToLeftTransition.RemoveFragmentAndTransform(NewFragment,BackFragment);break;
        }
    }
    ...
    public void popFragment(Bundle argBundle) {
        ...
        if (stackFragment.size() > 1) {
            ...
            if (fragment != null) {
                ...
                ft.add(R.id.fragment_switch_container, fragment, fragment.getClass().getSimpleName());
                ft.commitAllowingStateLoss();
            }
        }
        updateWhenChangeFragmentTop();
