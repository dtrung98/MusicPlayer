...
public abstract class DuplicatedWaveformFragment extends Fragment implements MarkerListener, WaveformListener {
    ...
    protected void loadGui(View view) {
        ...
        this.mPlayButton = (ImageButton)view.findViewById(id.play);
    ...
    protected void enableDisableButtons() {
        if(this.mIsPlaying) {
            ...
            this.mPlayButton.setContentDescription(this.getResources().getText(string.play));
        }
            ...
            try {
                ...
                if(startByte >= 0 && endByte >= 0) {
                    try {
                        ...
                        Log.e("WaveformFragment", "Exception trying to play file subset", var7);
                        this.mPlayer.reset();
                        this.mPlayer.setAudioStreamType(3);
